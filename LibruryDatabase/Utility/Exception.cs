...
namespace LibruryDatabase.Utility
{
    internal class Exception
    {
        ...
        public const string AGE_CHECK = @"^[0-9]{1,2}1?[0-9]?[0-9]$"; // 나이
        ...
        public const string BOOKNUMBER_CHECK = @"^[0-9]?[0-9]?[0-9]$"; //책번호
        public const string PUBLISH_DAY = @"^[0-9]{4}/[0-9]{2}/[0-9]{2}$"; // 출시일
        public const string QUANTITY = @"^[1-9]?[0-9]?[0-9]$"; // 수량
        public const string PRICE = @"^[0-9]{4,6}$"; // 가격
    }
}
